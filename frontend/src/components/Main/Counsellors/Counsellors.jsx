      ...
      exit={{x:window.innerWidth,transition:{duration:0.5}}}
       className="counsellor-container">
        <div className="counsellor-banner">
          ...
          />
          <motion.div
          animate={{y:0,scale:1,transition:{duration:0.5}}} initial={{scale:0}}
           className="counsellor-register">
            ...
            <div>
              <motion.button whileHover={{scale:1.1}} className="counsellor-btn" onClick={openPopup}>
                Register For Free
              </motion.button>
            </div>
          </motion.div>
            ...
            <Fade bottom>
                ...
                <Fade bottom>
                    ...
                    <div className='testimonies-card-container'>
                        ...
                        <motion.div whileHover={{scale:1.1}} className='testimonies-card'>
                            <img src={quote}></img>
                ...
                <Fade bottom>
                  <div className='counsellor-footer-register'>
                     ...
                     <div className='counsellor-footer-heading-lower'>
                         <motion.button whileHover={{scale:1.1}} className='counsellor-footer-btn' onClick={openPopup}>Register For Free</motion.button>
