    ...
    <div className="dashboard-main">
      ...
      <div className="dashboard-right">
        <div className="dashboard-right-container">
          ...
          <div className="prev-session csess-prev-session">Previous Sessions</div>
              ...
              <div className="previos-session-container">
                <div className="prev-session-flex">
                  ...
                  <div className="prev-session-counsellor">
                    <div  className="prev-session-counsellor-name">Client Name</div>
                    <div  className="prev-session-counsellor-topic">Topic</div>
                  </div>
                </div>

                <div className="prev-session-time">20 Sep 2023 7:30 - 8:30 PM</div>
