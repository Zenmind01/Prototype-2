      ...
      <div className="dashboard-left update-comm-left">
        ...
        <div className="admin-options">
          ...
          <div className="comm-sub-option">
            ...
            <a href="/counsellor-manage-community" className="comm-sub-option-1">
      ...
      <div className="dashboard-right">
        <div className="dashboard-right-container">
          <div className="community2-starter community2-starter-mb">
            ...
            <a href="/counsellor-community-discussion" className="comm-start-btn">+ Create new Discussion</a>
            <a href="/counsellor-community-discussion" className="comm-start-btn comm-start-btn-mb">+ New</a>
          </div>
              ...
              <div className="comm-grp-chats-container-m">
                ...
                <div className="comm-grp-content">
                  ...
                  <div className="comm-grp-content-p">
                    ...
                    felis. Suspendisse mollis euismod sapien, quis varius dolor
                    hendrerit quis. Suspendisse a condimentum mauris.
                  </div>
                </div>
              </div>
